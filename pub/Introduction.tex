...
As for the periodic arrival event rate, which is different from independent measurements, the observed event rate would be affected by the events in the former period~\cite{rapp2019dead,rapp2021highflux}.
